<?php
	...
	$permission_user = array(
		"home", "chequear_ingreso_usuario","detalles_propiedad","listar_propiedades_by_location", "logout","mostrar_contactanos", "ver_perfil", "agregar_tarjeta", "agregar_tarjeta_check", "modificar_vehiculo_check", "listar_tarjetas", "eliminar_tarjeta_check","listar_propiedades"
	);
