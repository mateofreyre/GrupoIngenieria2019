<?php
	...
	$permission_user = array(
		"home", "chequear_ingreso_usuario","modificar_mis_datos","modificar_usuario","check_modificar_usuario","alquilar_propiedad", "mostrar_perfil", "detalles_propiedad", "listar_propiedades_by_location", "logout", "mostrar_contactanos", "ver_perfil", "agregar_tarjeta", "agregar_tarjeta_check", "modificar_vehiculo_check", "listar_tarjetas", "eliminar_tarjeta_check", "listar_propiedades", "listar_propiedades_by_location", "detalles_propiedad", "chequear_ingreso_usuario"
	);
